...
Usando WHILE para loop
    Log To Console    ${\n}
    WHILE  ${STATUS} <= 5
        Log  Executando esse bloco enquanto o valo da variável STATUS [${STATUS}] for menor ou igual a 5!
        Log To Console  Executando esse bloco enquanto o valo da variável STATUS [${STATUS}] for menor ou igual a 5!
